...
const childParticipantSchema = new mongoose.Schema(
  {
    parentUserId: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true, index: true },
    childProfileId: { type: mongoose.Schema.Types.ObjectId, ref: 'ChildProfile', required: true, index: true },
...
module.exports = mongoose.model('ChildParticipant', childParticipantSchema);
