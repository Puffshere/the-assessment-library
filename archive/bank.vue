    ...
    <section class="bank-resources">
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <img class="bank-logo" src="~/assets/bankcode.png" alt="Codebreaker Free Business Resources by Assessments 24x7">
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p>
                        We’ve curated these resources specifically for Codebreaker customers that want to step up their OWN financial game. With over 4 hours of 
            ...
            <div class="row" id="contact">
                <div class="col-8">
                    ...
                    <contact-form redirect="/resources/lock/business-resources" acFormId="6" />
                </div>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'Codebreaker 20 Free Business Resources | Assessments 24x7',
                meta: [
                    {
                        hid: 'description',
                        name: 'description',
                        content: 'Here are 20 business resources by Dr. Tony Alessandra and Assessments 24x7, 100% free for Codebreaker customers!'
                    }
                ],
                link: [
                    {
