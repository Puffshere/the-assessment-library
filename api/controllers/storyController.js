...
export const generateChapter = async (req, res) => {
  try {
    ...
    const chapter = new StoryChapter({ childProfileId, chapterNumber, content, dominantTraitAtTime: dominantTrait, statsAtTime: stats })
    await chapter.save()
