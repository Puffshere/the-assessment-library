    ...
    <section class="juxtapose right">
        <div class="container">
            <div class="row">
                <div class="col-8">
                    <h3>{{ title }}</h3>
                    <span v-for="badge in badges" :key="badge.class" :class="'badge ' + badge.class">{{ badge.label }}</span>
                    <p v-html="body"></p>

                    <div class="languages" v-if="lang">
                        <span v-if="lang.indexOf('english') !== -1"><img src="~assets/flags/united-states-of-america.svg" alt="DISC Assessments"> English</span>
                        <span v-if="lang.indexOf('uk-english') !== -1"><img src="~assets/flags/united-kingdom.svg" alt="UK DISC Assessments"> UK English</span>
                        ...
                        <span v-if="lang.indexOf('indonesian') !== -1"><img src="~assets/flags/indonesia.svg" alt="Indonesian DISC Assessments"> Indonesian</span>
                ...
                <div class="col-4">
                    <img v-if="image == 'motivators'" class="image" src="https://cdn.assessments24x7.com/file/assessments24x7-media/Assessments/Motivators+Icon+for+Assessments.webp" :alt="alt"> 
                    <img v-if="image == 'critical-thinking'" class="image" src="~/assets/critical-thinking.png" :alt="alt"> 
                </div>
            </div>
        </div>
    </section>
