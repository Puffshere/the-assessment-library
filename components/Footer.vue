<template>
    <section class="footer" v-if="!hidden">
        <div class="container">
            <div class="row">
                <div class="col-4">
                ...
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <ul class="footer-links">
                            ...
                            <li class="link"><nuxt-link to="/certifications/directory/coaches">Coach Directory</nuxt-link></li>
                            <li class="link"><nuxt-link to="/certifications/directory/workshop-leaders">Workshop Leaders</nuxt-link></li>
                ...
                <div class="col-4">
                    ...
                    <!-- Facebook icon -->
                    <a class="contact-social" target="_blank" rel="noopener" href="https://www.facebook.com/Assessments247" aria-label="Like Assessments 24x7 on Facebook">
                    ...
                    <!-- Twitter icon -->
                    <a class="contact-social" target="_blank" rel="noopener" href="https://twitter.com/assessments24x7" aria-label="Follow Assessments 24x7 on Twitter">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <!-- LinkedIn icon -->
                    <a class="contact-social" target="_blank" rel="noopener" href="https://www.linkedin.com/company/assessments24x7" aria-label="Connect with Assessments 24x7 on LinkedIn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <!-- Instagram icon -->
                    <a class="contact-social" target="_blank" rel="noopener" href="https://www.instagram.com/assessments24x7/" aria-label="Connect with Assessments 24x7 on Instagram">
                    ...
                    <!-- YouTube icon -->
                    <a class="contact-social" target="_blank" rel="noopener" href="http://www.youtube.com/assessments24x7online" aria-label="Watch Assessments 24x7 on YouTube">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
