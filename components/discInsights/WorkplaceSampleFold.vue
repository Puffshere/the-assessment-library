...
export default {
    ...
    methods: {
        downloadWorkplaceSampleReport(event) {
            window.open('https://cdn.assessments24x7.com/file/assessments24x7-media/reports/SampleDISCworkplace.pdf', '_blank');
            event.target.blur();
        },
