            ...
            <div class="row">
                ...
                <div class="col-5 col-12-md" style="position:relative">
                        ...
                        <form class="form">
                            <ValidationObserver ref="form">
                                    ...
                                    <div class="form-group" style="margin-top: -16px">
                                        <ValidationProvider v-slot="v" rules="required">
                                            <input id="firstName" name="firstName" type="text" v-model="form.firstName"
                                                tabindex="1" placeholder="First Name *" />
                                    ...
                                    <div class="form-group">
                                        <ValidationProvider v-slot="v" rules="required|email">
                                            <input id="email" name="email" type="email" v-model="form.email"
                                                tabindex="3" placeholder="Email Address *" />
                                            <span class="error">{{ v.errors[0] }}</span>
                                        </ValidationProvider>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group" style="margin-top: -16px">
                                        <ValidationProvider v-slot="v" rules="required">
                                            <input id="lastName" name="lastName" type="text" v-model="form.lastName"
                                                tabindex="2" placeholder="Last Name *" />
                                            <span class="error">{{ v.errors[0] }}</span>
                                        </ValidationProvider>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group" style="margin-top: -16px">
                                        <ValidationProvider v-slot="v" rules="required">
                                            <input id="company" name="company" type="text" v-model="form.company"
                                                tabindex="5" placeholder="Company/Organization *" />
                                            <span class="error">{{ v.errors[0] }}</span>
                                        </ValidationProvider>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <ValidationProvider v-slot="v" rules="required">
                                            <input type="text" id="country" name="country" v-model="form.country"
                                                list="countries" autocomplete="country" tabindex="6"
                                                placeholder="Country *">
                                            <datalist id="countries">
                                                <option v-for="country in filteredCountries" :key="country.id"
                                                    :value="country.label">{{
                                                        country.label
                                                    }}</option>
                                            </datalist>
                                    ...
                                    <div class="form-group">
                                        <ValidationProvider v-slot="v" rules="required|min:5">
                                            ...
                                            <p class="error"
                                                style="position: absolute; margin-top: -2px; color: #fa8a8a;">{{
                                                    v.errors[0] }}</p>
                                        </ValidationProvider>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-top: -0px">
                                        <ValidationProvider v-slot="v" rules="required">
                                            <div class="form-check pill">
                                                <input class="form-check-input" id="reseller" name="clientType"
                                                    type="radio" value="Reseller" v-model="form.clientType" />
                                            ...
                                            <div class="form-check pill">
                                                <input class="form-check-input" id="corporate" name="clientType"
                                                    type="radio" value="Corporate" v-model="form.clientType" />
                                            ...
                                            <div class="form-check pill">
                                                <input class="form-check-input" id="retail" name="clientType"
                                                    type="radio" value="Retail" v-model="form.clientType" />
                                                <label class="form-check-label" for="retail">I am an
                                                    <strong>individual</strong> looking
                                ...
                                <button :disabled="isDisabled"
                                    :class="{ 'button secondary': true, 'disabled': isDisabled }" type="button"
                                    @click="process" style="width: 100%; margin-top: -10px; margin-bottom: 10px">{{
                    ...
                    <span class="legal-form-text">
                        By submitting this form, I agree to the <nuxt-link to="/legal/privacy"
                            class="hyperlink light">Privacy Policy</nuxt-link> and
                        <nuxt-link to="/legal/compliance" class="hyperlink light">GDPR Policy</nuxt-link> and give my
                        consent.
                    </span>
                </div>
            </div>
