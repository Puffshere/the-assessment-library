  ...
  <section class="unlockFold">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="col-6">
            <img ref="unlockImage" class="unlock-image" alt="Image of assessments and phone" style="width: 100%; margin-top: 50px;">
          </div>
          <div class="col-6">
...
export default {
  ...
  mounted() {
    // Use the mixin method to set the correct image source based on OS detection
    const imgElement = this.$refs.unlockImage;
    this.setUnlockImage(
      imgElement,
      "https://cdn.assessments24x7.com/file/assessments24x7-media/Success+Magazine/DISC+Report+with+assessment.png",
      "https://cdn.assessments24x7.com/file/assessments24x7-media/Success+Magazine/DISC+Report+and+phone+(1).webp"
    );
  }
};
</script>
