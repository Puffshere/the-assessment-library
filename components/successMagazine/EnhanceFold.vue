                ...
                <div class="row">
                    <div class="col-12">
                        <h1 style="color: white; text-align: center;">
                            Enhance Your Services with <br />
                            Customizable Assessments and Training Tools
                        </h1>
                        <p style="color: white; text-align: center; margin-bottom: -10px;">
                            Leverage our platform to enhance your professional services with access to over 50
                            customizable
                            assessments, all managed through a user-friendly, premium dashboard. Impress your clients
                            with
                            in-depth, actionable insights from these reports, while efficiently tailoring assessments to
                            meet specific needs. With these tools, you can optimize service delivery, boost client
                            satisfaction, and increase revenue. Plus, access over 500 training resources—including
                            PowerPoints, videos, and group exercises—to enrich your sessions and maximize the value you
                            provide to clients.
                        </p>
                    </div>
                </div>
                                ...
                                <div v-for="(card, index) in cards" :key="index"
                                    ...
                                    <div class="custom-card">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <h5 style="margin-top: -20px; margin-bottom: 10px;">{{ card.languages }}
                                            </h5>
