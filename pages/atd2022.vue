    ...
    <section class="bizx">
        ...
        <section class="banner">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <img class="bizx-logo" src="~/assets/atd-alt.png" alt="ATD">
            ...
            <div class="container">
                ...
                <div class="row" style="margin-top: 75px">
                    <div class="col-12" style="text-align: center">
                        <h6 style="margin-bottom: 20px;">Save even more! Purchase both certifications for $3,495</h6>
                        <a href="https://buy.stripe.com/4gwdRqdPDgP5dvW14H" target="_blank" class="button secondary">Purchase Certification Bundle</a>
                    </div>
                </div>
