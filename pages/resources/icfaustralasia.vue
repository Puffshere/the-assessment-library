    ...
    <section class="ebook-resources">
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <img class="ausasia-logo" src="~/assets/icf-ausasia-logo.png" alt="ICF Australasia Free eBooks | Assessments 24x7">
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <h2 class="subtitle">ICF Australasia - Get 9 Full-Length eBooks by Dr. Tony Alessandra</h2>
                </div>
            </div>
                            ...
                            <div class="infusion-radio">
                                <div class="options-container">
                                    <div class="infusion-option">
                                        ...
                                        <label for="inf_option_Imlookingformoreinformationon_3174">Using assessments with my clients as an independent coach, trainer, or consultant coach, trainer, or consultant</label>
                                    </div>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'ICF Australasia Free eBooks | Assessments 24x7',
                meta: [
                    {
                        hid: 'description',
                        name: 'description',
                        content: 'Here are 9 full published business eBooks by Dr. Tony Alessandra free for ICF Australasia!'
                    }
                ]
            }
        }
