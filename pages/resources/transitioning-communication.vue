    ...
    <section class="skeleton">
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title">Using DISC in a World of Transitioning Communication</h1>
                        <p>
                            Effective communication is crucial to building high-quality, meaningful relationships. During the continued transitions in our 
                            personal and professional lives, there may be nothing as important as being able to effectively recognize, understand, and 
                            interact with others despite the method used for connecting!
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <iframe style="width:100%" height="515" src="https://www.youtube.com/embed/Ot1Jo0dL3Vk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'Using DISC in a World of Transitioning Communication Webinar | Assessments 24x7',
                meta: [
                    {
                        hid: 'description',
                        name: 'description',
                        content: 'Explore how to use simple tools and strategies in any interaction to effectively discern and distinguish the behavioral styles of others.'
                    }
                ]
            }
        }
