    ...
    <section class="skeleton">
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title">Training Materials Webinar</h1>
                        <p>
                            Join our Assessments 24x7 Certification & Training team for an overview of our training materials and resources. This will 
                            serve to deepen your knowledge of the available materials and further develop your ability to apply the tools effectively, no 
                            matter what your current level of understanding.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <a target="_blank" rel="noopener" href="https://cdn.assessments24x7.com/file/assessments24x7-media/webinars/A24x7_WEBINAR_Training_Materials.pdf" class="button" style="float:right"><img class="pdf-icon" src="~/assets/pdf-icon.svg"> Download the Slide Deck</a>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'Training Materials Webinar | Assessments 24x7',
                meta: [
                    {
                        hid: 'description',
                        name: 'description',
                        content: 'Join our Assessments 24x7 Certification & Training team for an overview of our training materials and resources. This will serve to deepen your knowledge of the available materials.'
                    }
                ]
            }
        }
