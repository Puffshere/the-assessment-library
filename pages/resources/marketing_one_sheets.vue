                    ...
                    <div class="post">
                        <div class="post-inner">
                            <div class="image-column">
                                <img class="cardImage" src="~/assets/magnifying_glass.png">
                            </div>
            ...
            <div class="row">
                <div class="content-box">
                    <div class="post">
                        <div class="post-inner">
                            <div class="image-column">
                                <img class="cardImage" src="~/assets/tools_image.png">
                            </div>
                            <div class="text-column">
                                <div class="header">
                                    <p class="cardTitle">TOOLS SERIES</p>
                                </div>
                                <div>
                                    <span class="cardDescription">Assessments & related instruments</span>
                                    <br>
                                    <br>
                                    <div class="row">
                                        <div class="cardBody">
    ...
    data() {
        return {
            ...
            toolsPosts: [
                ...
                {
                    id: 9,
                    title: 'DISC Awareness (download PDF)',
                ...
                {
                    id: 10,
                    title: 'DISC Leadership (download PDF)',
                ...
                {
                    id: 11,
                    title: 'DISC Workplace Insights (download PDF)',
                ...
                {
                    id: 12,
                    title: 'DISC Executive Insights (download PDF)',
