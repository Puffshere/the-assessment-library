    ...
    <section class="video-resources">
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title">Free Business Video Resources</h1>
                        <p>
                            Here are 11 professionally filmed business video lectures by Dr. Tony Alessandra – all yours for free!
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <img class="banner-image" src="~/assets/video-resources.jpg"><br/>
                    <h2 class="subtitle">Get 11 Professionally Filmed Business Video Lectures</h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-8">
                    <h3>Get Your <span>Free Video Resources</span></h3>
                    <form accept-charset="UTF-8" action="https://rz189.infusionsoft.com/app/form/process/8b53db34dafb7bdf30abb5b45691e19b" class="infusion-form" id="inf_form_8b53db34dafb7bdf30abb5b45691e19b" method="POST">
                        <input name="inf_form_xid" type="hidden" value="8b53db34dafb7bdf30abb5b45691e19b" />
                        <input name="inf_form_name" type="hidden" value="Video Optin" />
                            ...
                            <div class="infusion-radio">
                                <div class="options-container">
                                    <div class="infusion-option">
                                        <input id="inf_option_Imlookingformoreinformationon_3086" name="inf_option_Imlookingformoreinformationon" type="radio" value="3086" />
                                        <label for="inf_option_Imlookingformoreinformationon_3086">Using assessments with my clients as an independent coach, trainer, or consultant coach, trainer, or consultant</label>
                                    </div>

                                    <div class="infusion-option">
                                        <input id="inf_option_Imlookingformoreinformationon_3088" name="inf_option_Imlookingformoreinformationon" type="radio" value="3088" />
                                        <label for="inf_option_Imlookingformoreinformationon_3088">Using assessments internally with our team as a part of our organization (corporation, association, etc.)</label>
                                    </div>
                                </div>
                            </div>
                        </div><br/>
                            ...
                            <div class="infusion-radio">
                                <div class="options-container">
                                    <span class="infusion-option">
                                        <input id="inf_option_Pleaseselect_3090" name="inf_option_Pleaseselect" type="radio" value="3090" />
                                        <label for="inf_option_Pleaseselect_3090">Yes please!</label>
                                    </span>

                                    <span class="infusion-option">
                                        <input id="inf_option_Pleaseselect_3092" name="inf_option_Pleaseselect" type="radio" value="3092" />
                                        <label for="inf_option_Pleaseselect_3092">No, thank you</label>
                                    </span>
                                </div>
                            </div>
                        </div><br/>
                        ...
                        <div class="infusion-field">
                            <span class="infusion-option">
                                <label for="inf_option_IagreetothePrivacyPolicyandgivemyconsent">
                                    <input id="inf_option_IagreetothePrivacyPolicyandgivemyconsent" name="inf_option_IagreetothePrivacyPolicyandgivemyconsent" type="checkbox" value="3094" />
                    ...
                    <script type="text/javascript" src="https://rz189.infusionsoft.com/app/timezone/timezoneInputJs?xid=8b53db34dafb7bdf30abb5b45691e19b"></script>
                </div>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'Video Resources | Assessments 24x7',
                meta: [
                    {
                        hid: 'description',
                        name: 'description',
                        content: 'Here are 11 professionally filmed business video lectures by Dr. Tony Alessandra – all yours for free!'
                    }
                ]
            }
        }
