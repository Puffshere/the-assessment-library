    ...
    <section class="ebook-resources">
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title">Free Sales &amp; Business eBook Resources</h1>
                        <p>
                            Here are 9 full published business eBooks by Dr. Tony Alessandra – all yours for free!
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <h2 class="subtitle">Get 9 Full-Length eBooks by Dr. Tony Alessandra</h2>
                </div>
            </div>

            <div class="row">
                <div class="col-6">
                    <h4>Collaborative Selling</h4>
                    <p>
                        ...
                        <br/><span class="badge">Pages: <strong>143</strong></span>
                    </p>

                    <h4>Game Changing Life Strategies</h4>
                    <p>
                        ...
                        <br/><span class="badge">Pages: <strong>72</strong></span>
                    </p>

                    <h4>Non-Manipulative Selling</h4>
                    <p>
                        ...
                        <br/><span class="badge">Pages: <strong>186</strong></span>
                    </p>

                    <h4>People Smart in Business</h4>
                    <p>
                        ...
                        <br/><span class="badge">Pages: <strong>220</strong></span>
                    </p>

                    <h4>People Smart with Family and Friends</h4>
                    <p>
                ...
                <div class="col-6">
                    ...
                    <p>
                        ...
                        <br/><span class="badge">Pages: <strong>169</strong></span>
                    </p>

                    <h4>Platinum Rule for DISC Sales Mastery</h4>
                    <p>
                        ...
                        <br/><span class="badge">Pages: <strong>235</strong></span>
                    </p>

                    <h4>Platinum Rule for Small Business Mastery</h4>
                    <p>
                        ...
                        messages.
                        <br/><span class="badge">Pages: <strong>176</strong></span>
                    </p>

                    <h4>Platinum Rule for Trade Show Mastery</h4>
                    <p>
            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <form accept-charset="UTF-8" action="https://rz189.infusionsoft.com/app/form/process/a165ae14014a141dfb7a246d2541e74d" class="infusion-form" id="inf_form_a165ae14014a141dfb7a246d2541e74d" method="POST">
                        <input name="inf_form_xid" type="hidden" value="a165ae14014a141dfb7a246d2541e74d" />
                        <input name="inf_form_name" type="hidden" value="Ebook Optin" />
                        <input name="infusionsoft_version" type="hidden" value="1.70.0.256007" />
                            ...
                            <div class="infusion-radio">
                                <div class="options-container">
                                    <div class="infusion-option">
                                        <input id="inf_option_Imlookingformoreinformationon_3076" name="inf_option_Imlookingformoreinformationon" type="radio" value="3076" />
                                        <label for="inf_option_Imlookingformoreinformationon_3076">Using assessments with my clients as an independent coach, trainer, or consultant coach, trainer, or consultant</label>
                                    </div>

                                    <div class="infusion-option">
                                        <input id="inf_option_Imlookingformoreinformationon_3078" name="inf_option_Imlookingformoreinformationon" type="radio" value="3078" />
                                        <label for="inf_option_Imlookingformoreinformationon_3078">Using assessments internally with our team as a part of our organization (corporation, association, etc.)</label>
                                    </div>
                                </div>
                            </div>
                        </div><br>
                            ...
                            <div class="infusion-radio">
                                <div class="options-container">
                                    <span class="infusion-option">
                                        <input id="inf_option_Pleaseselect_3080" name="inf_option_Pleaseselect" type="radio" value="3080" />
                                        <label for="inf_option_Pleaseselect_3080">Yes please!</label>
                                    </span>

                                    <span class="infusion-option">
                                        <input id="inf_option_Pleaseselect_3082" name="inf_option_Pleaseselect" type="radio" value="3082" />
                                        <label for="inf_option_Pleaseselect_3082">No, thank you</label>
                                    </span>
                                </div>
                            </div>
                        </div><br>
                        ...
                        <div class="infusion-field">
                            <span class="infusion-option">
                                <label for="inf_option_IagreetothePrivacyPolicyandgivemyconsent">
                                    <input id="inf_option_IagreetothePrivacyPolicyandgivemyconsent" name="inf_option_IagreetothePrivacyPolicyandgivemyconsent" type="checkbox" value="3084" />
                    ...
                    <script type="text/javascript" src="https://rz189.infusionsoft.com/app/timezone/timezoneInputJs?xid=a165ae14014a141dfb7a246d2541e74d"></script>
                </div>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'eBook Resources | Assessments 24x7',
                meta: [
                    {
                        hid: 'description',
                        name: 'description',
                        content: 'Here are 9 full published business eBooks by Dr. Tony Alessandra – all yours for free!'
                    }
                ]
            }
        }
