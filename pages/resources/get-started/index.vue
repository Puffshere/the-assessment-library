                ...
                <div class="col-12">
                    <div class="step">
                        ...
                        <div class="body">
                            ...
                            <p class="text">
                                In the Resource Center module, review the available training materials. These materials
                                are for your education and can also be used as marketing
                ...
                <div class="col-12">
                    <div class="step">
                        ...
                        <div class="body">
                            ...
                            <p class="text">
                                We recommend taking demo assessments to learn more about a particular assessment. You
                                can do this by clicking on the DEMO ASSESSMENTS button in your
                                resource center on the home page of your account.
                            </p>

                            <img style="width:100%;max-width:700px;margin:20px auto 0;display:block"
                                src="~/assets/demo-assessments-ss.jpg" alt="demo-assessments">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="body">
                            ...
                            <p class="text">
                                ...
                                Would you like a personalized dashboard tour? Contact us at <a
                                    href="mailto:support@assessments.ws" class="hyperlink">support@assessments.ws</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="sample-reports">
                        ...
                        <a href="https://youtu.be/wqXCukZr9LI" target="_blank" rel="noopener">
                            <div class="sample">
                                <img src="~assets/youtube-icon.svg" alt="youtube-icon"> Dr. Tony Alessandra's DISC
                                Speech
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    viewBox="0 0 185.343 185.343">
                        ...
                        <a v-if="noframe" href="/resources/relationship-strategies-audio-program?noframe=1"
                            target="_blank" rel="noopener">
                            <div class="sample">
                                <img src="~assets/internet-icon.svg" alt="internet-icon"> DISC Relationship Strategies
                                Audio Program
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    viewBox="0 0 185.343 185.343">
...
export default {
    ...
    created() {
        if (this.$route.query.id === 'ccc') {
            ...
            this.id = 'tonyrobbins';
        } else if (this.$route.query.id === 'engageandgrow') {
            this.url = 'assessments123.com';
            this.id = 'engageandgrow';
