                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <img v-else-if="id === 'tonyrobbins'" src="~/assets/get-started/tonyrobbins.png"
                            alt="Tony Robbins" class="partner-logo">
                        <img v-else-if="id === 'engageandgrow'" src="~/assets/get-started/engage-and-grow.png"
                            alt="Engage and Grow" class="partner-logo">
                        <img v-else-if="id === 'ref'" id="ref" src="~/assets/get-started/REF-logo-white-2000px.png"
                        ...
                        <p v-if="id === 'tonyrobbins'">
                            Welcome to your personal Tony Robbins DISC and Motivators assessment dashboard. Here are the
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p v-if="id === 'tonyrobbins'">
                        Welcome to your personal Tony Robbins DISC and Motivators assessment dashboard! Be sure to have
                        a look at the announcements on the
                        left side of your dashboard. We invite you to view any and all materials that look interesting
                        to you, but if you’d like some
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <p class="text">
                                    Don't have an account yet? Set your account up and it will be available immediately.
                                    Already have an account? You can sign in using the button below.
                                </p><br />

                                <a class="button" href="https://tonyrobbinsassessments.com/register_acct.aspx"
                                    target="_blank" rel="noopener">Set up your account</a>
                                <a class="button secondary" href="https://tonyrobbinsassessments.com/Account"
                                    target="_blank" rel="noopener">Already have an account? Sign in</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <p class="text">
                                    Log in and send DISC and Motivator assessments. <a class="hyperlink"
                                        href="https://cdn.assessments24x7.com/file/assessments24x7-media/tony-robbins/TR+Quick+Steps.pdf"
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <iframe style="width:100%" height="239"
                                            src="https://www.youtube.com/embed/W9mA3GuxqC4" frameborder="0"
                                            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                            allowfullscreen></iframe>
                                        <a class="hyperlink" href="https://youtu.be/W9mA3GuxqC4" target="_blank"
                                            rel="noopener">
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <p class="text">
                                    Run Group and Team Reports. Personalize your branding. Create Collaboration reports.
                                    Set up additional assessment links.
                                </p><br />

                                <a class="button" href="https://www.assessments24x7.com/virtual-tour" target="_blank"
                                    rel="noopener">Take the full virtual tour</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <p class="text">
                                    Access to DISC and Motivator training materials are located on your account
                                    dashboard. These are full of PowerPoints,
                                    group exercises, debrief guides, videos, audio recordings, and etc.
                                </p>

                                <img style="width:100%;max-width:700px;margin:20px auto 0;display:block"
                                    src="~/assets/resource-center-ss-tr.png">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <p class="text">
                                    If you require further information or need assistance about your account, schedule
                                    time with your Assessments 24x7
                                    Coach or email <a class="hyperlink"
                                        href="mailto:support@assessments.ws">support@assessments.ws</a>.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <a class="button" href="https://refassessments.com/register_acct.aspx" target="_blank"
                                    rel="noopener">Set up your account</a>
                                <a class="button secondary" href="https://refassessments.com/Account" target="_blank"
                                    rel="noopener">Already have an account? Sign in</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <p class="text">
                                    These videos can also be found in the "Resource Center" on your account dashboard
                                    page.
                                </p><br />
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <p class="text">
                                    This Admin Quick Setup Steps PDF gives you 3 quick steps to get your admin dashboard
                                    configured.
                                </p>

                                <a class="link"
                                    href="https://drive.google.com/file/d/1oBrb95DWABjZH1LqSoKWOsJgpMuyy3Nr/view"
                                    target="_blank" rel="noopener">
                                    <img style="width:30px;margin-right:6px" src="~/assets/pdf-icon.svg"
                                        alt="Download the Quick Start Guide PDF">Download the Quick Start Guide
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <p class="text">
                                    In the Resource Center module, review the available training materials. These
                                    materials are for your education and can also be used as marketing
                                    and training materials for your clients. These educational materials are a great
                                    opportunity for you to run sessions for your clients.
                                </p>

                                <img style="width:100%;max-width:700px;margin:20px auto 0;display:block"
                                    src="~/assets/resource-center-ss.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <p class="text">
                                    We recommend taking demo assessments to learn more about a particular assessment.
                                    You can do this by clicking on the DEMO ASSESSMENTS button in your
                                    resource center on the home page of your account.
                                </p>

                                <img style="width:100%;max-width:700px;margin:20px auto 0;display:block"
                                    src="~/assets/demo-assessments-ss.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <p class="text">
                                    Identify at least one customer who you believe can benefit from one or more of your
                                    assessments and send them a sample link to take it.
                                    Would you like a personalized dashboard tour? Contact us at <a
                                        href="mailto:support@assessments.ws"
                                        class="hyperlink">support@assessments.ws</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="step">
                            ...
                            <div class="body">
                                ...
                                <p class="text">
                                    Schedule your appointment with Angie at <a
                                        href="https://www.assessments24x7.com/angie"
            ...
            <div v-if="id !== 'tonyrobbins'" class="row">
                <div class="col-6">
                    ...
                    <p>
                        ...
                        for a complete professional spectrum - customer
                        service, vocational, technical, sales, management or executive needs. It's important for
                        employees to have the necessary skills to demonstrate
                        the attitudes and behaviors that would enable them to succeed within each company's unique
                        environment.
                    </p><br />
                    <a href="/about/why-use-assessments" class="button">Learn More About Assessments</a>
                </div>
                ...
                <div class="col-6">
                    <div class="sample-reports">
                        ...
                        <a v-if="noframe" href="/resources/relationship-strategies-audio-program?noframe=1"
                            target="_blank" rel="noopener">
                            <div class="sample">
            ...
            <section class="certifications">
                <div class="row">
                    <div class="col-12">
                        <div class="images">
                            <img class="image"
                                src="https://f002.backblazeb2.com/file/assessments24x7-media/badges/new/disc-cert-badge-color-label.png"
                                alt="">
                            <img class="image"
                                src="https://f002.backblazeb2.com/file/assessments24x7-media/badges/new/mot-cert-badge-color-label.png"
                                alt="">
                            <img class="image"
                                src="https://f002.backblazeb2.com/file/assessments24x7-media/badges/new/eiq-cert-badge-color-label.png"
                                alt="">
                        </div>
                        ...
                        <p>
                            Assessments 24x7 developed a variety of robust assessment certification programs, designed
                            specifically for coaches,
                            consultants and trainers to take their businesses to the next level. Each of our
                            certification programs are blended
                            learning modalities, including self-paced learning for your convenience and 1-on-1
                            instructor-led sessions (via Zoom
                            or Skype). These are not cookie-cutter online classes, but flexible training curriculums
...
export default {
    ...
    created() {
        ...
        if (this.$route.query.cert === '0') {
            this.cert = false;
        }
    },
    head() {
        return {
            title: 'Get Started | Assessments 24x7',
            meta: [
                {
                    hid: 'description',
                    name: 'description',
                    content: 'Welcome to your personal coaching dashboard! We invite you to view any and all materials that look interesting to you, but if you’d like some guidance, follow our suggested steps below.'
                }
            ]
        }
    }
