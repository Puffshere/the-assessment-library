    ...
    <section class="skeleton">
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title">Surprising Facts That You Didn’t Know About DISC... But Should!</h1>
                        <p>
                            For our final webinar of 2021, we are thrilled to turn the camera and mic over to the DISC mastermind himself, Dr. Russ Watson. 
                            No matter what your previous experience with DISC has been, you’re guaranteed to pick up some additional nuggets of information 
                            about DISC history and leave with the confidence that you know a bit more about positioning this assessment in practice.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <h4 style="float:left">DISC: Unraveling the BIG Misconceptions (44 minutes)<br/>Uploaded November 17th, 2021</h4>
                ...
                <div class="col-12">
                    <iframe style="width:100%" height="515" src="https://www.youtube.com/embed/buh5HGsmFYM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
