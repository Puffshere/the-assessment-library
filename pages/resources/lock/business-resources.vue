<template>
    <section class="ebook-resources-lock">
        <main-nav></main-nav>
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title">Free Business Resources</h1>
                        <p>
                            Here are 20 business resources by Dr. Tony Alessandra and Assessments 24x7 – all yours for free!
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>Here Are Your Free Business Resources!</h2>

                    <p>
                        Thank you for submitting the form to receive these <strong>20 free business resources</strong>. If you are interested about
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'Download eBook Resources | Assessments 24x7',
                meta: [
                    {
                        hid: 'description',
                        name: 'description',
