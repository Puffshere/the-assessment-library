    ...
    <section class="skeleton">
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title">Solution-Driven Applications with DISC</h1>
                        <p>
                            When utilized in personal relationships, professional interactions, or any situation in which greater understanding is 
                            essential for growth, DISC and its supplementary assessments offer insights that can lead to better connections, mutually 
                            beneficial results, and incredible outcomes!
                        </p>
                    </div>
                </div>
            </div>
