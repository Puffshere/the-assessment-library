    ...
    <section class="skeleton">
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title">Use Your Assessment Dashboard Like a Pro!</h1>
                        <p>
                            In this webinar, Suzette Chaparro, VP of Client Success, will step you through the best practices for streamlining your 
                            workflow and getting the most from your Assessments 24x7 dashboard.
                        </p>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'Use Your Assessment Dashboard Like a Pro! | Assessments 24x7',
                meta: [
                    {
                        hid: 'description',
                        name: 'description',
                        content: 'In this webinar, Suzette Chaparro, VP of Client Success, will step you through the best practices for streamlining your workflow and getting the most from your Assessments 24x7 dashboard.'
                    }
                ]
            }
        }
