<template>
    <section class="workshop-leader-resources">
        <main-nav/>
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title">DISC Workshop Leader Trainer Materials</h1>
                        <p>
                            You have been selected for your ability to engage, teach, and wow learners by challenging participants to think differently, 
                            focus new ideas in a way that really works, and leave training sessions eager to apply their new skills. Whether your next 
                            workshop is for a group of 5 or 500, get the confidence and content quickly that normally only comes after months or years of 
        ...
        <div class="container" v-if="unlocked">
            <div class="row">
                <div class="col-12">
                    <h2>Workshop Leader Certification</h2><br/>
                    <p>
                    ...
                    <p>
                        The goal of these training-in-a-box certifications is to bridge the gap further between assessment content and interactive application 
            ...
            <div class="row">
                <div class="col-6">
                    <h2>
                        <img class="icon" src="~/assets/trainer-materials-icons/powerpoint-slides.png" alt="Training Webinars">
                        Training Webinars
                    </h2>
                    ...
                    <h2>
                        <img class="icon" src="~/assets/trainer-materials-icons/know-disc.png" alt="Continuing Education Resources">
                    ...
                    <table style="width:100%">
                        <thead>
                            <tr>
                                <th>Continuing Education Resources</th>
                            </tr>
                        </thead>
                ...
                <div class="col-6">
                    <h2>
                        <img class="icon" src="~/assets/trainer-materials-icons/2-hour-presentation.png" alt="Training Materials">
                        Training Materials
                    </h2>
                    ...
                    <h2>
                        <img class="icon" src="~/assets/trainer-materials-icons/background-materials.png" alt="Marketing Materials">
                        Marketing Materials
                    </h2>
                ...
                <div class="col-12">
                    <div class="password-prompt">
                        <div class="info">
                            ...
                            <p>
                                These trainer material resources are only available for Assessments 24x7 account holders. Please use the password provided 
                                to you in your Resource Center.
                            </p>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            unlock() {
                if (this.password === 'DWLcertified' || this.password === 'dwlcertified') {
                    this.unlocked = true;
                } else {
        ...
        head() {
            return {
                title: 'DISC Workshop Leader Trainer Materials | Assessments 24x7',
                meta: [
                    {
                        hid: 'description',
                        name: 'description',
                        content: 'Whether your next workshop is for a group of 5 or 500, get the confidence and content quickly that normally only comes after months or years of research and development.'
                    }
                ]
            }
        }
