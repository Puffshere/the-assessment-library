            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="samples-container">
                        ...
                        <a class="language-button other" @click="le360ReportModal = true">2 languages</a><br/>
                    </div>
                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a class="language-button disc" @click="discTeamDynamicsReportModal = true">7 languages</a><br/>
