            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="samples-container-special">
                        ...
                        <a class="language-button disc" @click="disc360ReportModal = true">6 languages</a><br />
                    </div>
                    <br />
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="samples-container">
                        ...
                        <a v-if="lang === 'en-us'"
                            href="https://cdn.assessments24x7.com/file/assessments24x7-media/reports/Report_Sample_DISC_Awareness_(EI).pdf.pdf"
                            class="hyperlink" target="_blank" rel="noopener">DISC Awareness (EI) Report</a>
                    </div>
                </div>
                ...
                <div class="col-3">
                    <div class="samples-container">
                        ...
                        <a v-else-if="lang === 'fr'"
                            ...
                            class="hyperlink" target="_blank" rel="noopener">Emotional Intelligence 360&deg;</a>
                        <a v-else-if="lang === 'ru'"
                            href="https://cdn.assessments24x7.com/file/assessments24x7-media/reports/EIQ360RussianSampleReport.pdf"
                            class="hyperlink" target="_blank" rel="noopener">Emotional Intelligence 360&deg;</a>
                        <a v-else-if="lang === 'es'"
