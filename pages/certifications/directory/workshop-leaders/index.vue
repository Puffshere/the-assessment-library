        ...
        <section class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p>
                        These experienced trainers have been selected for their abilities to engage, teach, and wow learners by challenging participants 
                        to think differently, focus new ideas in a way that really works, and leave training sessions eager to apply their new skills.
                    </p>

                    <nuxt-link to="/certifications/workshop-certification" class="button">Discover our Training Program</nuxt-link>
                </div>
            </div>
                    ...
                    <table style="width:100%">
                        ...
                        <tbody>
                            <tr v-for="leader in leaders" :key="leader.stub">
                                <td>
                                    <nuxt-link class="hyperlink" :to="`/certifications/directory/workshop-leaders/${leader.stub}`">
                                        {{ leader.name }}
                                    </nuxt-link>
                                </td>
                                <td>{{ leader.city }}</td>
