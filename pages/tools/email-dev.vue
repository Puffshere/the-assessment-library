            ...
            <div class="container">
                ...
                <div class="container bar2">
                    <div class="row col-12 button-container">
                        ...
                        <div class="col-2">
                            <button @click="analyzeEmail" class="btn analyzeBtn">Analyze</button>
                        </div>
                        ...
                        <div class="col-3 ">
                            ...
                            <button v-else @click="templateOptions" class="templates btn">Templates</button>
                        </div>
...
Here's the original email:`
        ...
        promptAnalyze() {
            return `Given the following email, please determine which DISC personality style (Dominance, Influence, Steadiness, Conscientiousness) it most closely aligns with and provide three reasons for your choice:
...
- Steadiness: Even-tempered, patient, humble, and tactful.
- Conscientiousness: Analytical, reserved, precise, and systematic.

Which DISC style does the email align with, and why?
`
        },
        promptTranslate() {
    ...
    methods: {
        ...
        async analyzeEmail() {
            if (this.userInput && this.userInput !== "Please add text to be analyzed!") {
                this.isLoading = true;
                // Code needed for development
                // const endpoint = "http://localhost:3000/api/completions";
                const endpoint = "/api/completions";
                const analyzedEmail = this.promptAnalyze;

                try {
                    const result = await axios.post(endpoint, { input: analyzedEmail });
                ...
                this.userInput = "Please add text to be analyzed!"
            }
        },
        templateOptions() {
...
.email {
    ...
    .body {
        ...
        .analyzeBtn {
            padding: 10px;
            background: linear-gradient(268deg, #e4756b, #e93d2f);
        }

        .analyzeBtn:hover {
            background: linear-gradient(268deg, #cc685f, #d1382a);
            box-shadow: 2px 2px 5px rgb(61, 61, 61);
        }

        .analyzeBtn:focus {
            background: linear-gradient(268deg, #ad5850, #b32f23);
            box-shadow: 1px 1px 5px rgb(61, 61, 61);
        }

        .swap {
            background: linear-gradient(268deg, #f8f859, #ffff00);
            padding: 10px;
            color: rgb(59, 59, 59);
        }

        .swap:hover {
            background: linear-gradient(268deg, #dada4e, #e9e901);
            box-shadow: 2px 2px 5px rgb(61, 61, 61);
        }

        .swap:focus {
            background: linear-gradient(268deg, #bdbd44, #cece01);
            box-shadow: 1px 1px 5px rgb(61, 61, 61);
        }

        .templates {
            background: linear-gradient(268deg, #4485fd, #1666ff);
            padding: 10px;
        }

        .templates:hover {
            background: linear-gradient(268deg, #3d77e2, #135de7);
            box-shadow: 2px 2px 5px rgb(61, 61, 61);
        }

        .templates:focus {
            background: linear-gradient(268deg, #386cce, #1055d3);
            box-shadow: 1px 1px 5px rgb(61, 61, 61);
        }

        .submit {
            background: linear-gradient(268deg, #4bc960, #09b409);
            float: right;
            padding: 10px;
        }

        .submit:hover {
            background: linear-gradient(268deg, #41af53, #079b07);
            box-shadow: 2px 2px 5px rgb(61, 61, 61);
        }

        .submit:focus {
            background: linear-gradient(268deg, #359245, #057c05);
            box-shadow: 1px 1px 5px rgb(61, 61, 61);
        }
