    ...
    data() {
        return {
            ...
            languages: [
                ...
                { id: 4, name: 'Croatian' },
                { id: 5, name: 'Danish' },
                { id: 6, name: 'Dutch (Standard)' },
                { id: 7, name: 'English (Australia)' },
                { id: 8, name: 'English (United Kingdom)' },
                { id: 9, name: 'Finnish' },
                { id: 10, name: 'French (Canada)' },
                { id: 11, name: 'French (France)' },
                { id: 12, name: 'German (Germany)' },
                { id: 13, name: 'Hungarian' },
                { id: 14, name: 'Indonesian' },
                { id: 15, name: 'Italian' },
                { id: 16, name: 'Japanese' },
                { id: 17, name: 'Khmer (Cambodia)' },
                { id: 18, name: 'Korean' },
                { id: 19, name: 'Latvian' },
                { id: 20, name: 'Lithuanian' },
                { id: 21, name: 'Malay (Malaysia)' },
                { id: 22, name: 'Norwegian' },
                { id: 23, name: 'Polish' },
                { id: 24, name: 'Portuguese (Brazil)' },
                { id: 25, name: 'Portuguese (Portugal)' },
                { id: 26, name: 'Romanian' },
                { id: 27, name: 'Russian' },
                { id: 28, name: 'Slovak' },
                { id: 29, name: 'Spanish' },
                { id: 30, name: 'Spanish (Latin Americana)' },
                { id: 31, name: 'Spanish (Spain)' },
                { id: 32, name: 'Swedish' },
                { id: 33, name: 'Turkish' },
                { id: 34, name: 'Vietnamese' },
            ],
            items: [
                { id: 1, name: 'Pure D' },
                { id: 2, name: 'Pure I' },
