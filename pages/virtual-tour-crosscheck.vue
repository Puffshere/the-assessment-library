    ...
    <section class="virtual-tour">
        ...
        <section class="header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title">Account Dashboard Virtual Tour</h1>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="row" id="heroFold">
                <div class="col-12">
                    ...
                    <p style="line-height: 20px; margin-top: -10px; margin-bottom: 50px;">Here are our recommended steps
                        based on thousands of account setups. Skip sections as needed and proceed at your own pace. To
                        schedule a one-on-one dashboard tour email us at email us at
                        <a class="hyperlink" href="mailto:contact@crosscheck.com.au"> contact@crosscheck.com.au</a> to
                        book a time. <br />
                        <br />
                        For information on assessments, pricing, and resources, contact
                        <span><a class="hyperlink"
                                href="mailto:contact@crosscheck.com.au">contact@crosscheck.com.au</a></span>.
                    </p>
