...
const questions = [
    {
        ...
        timeline: `Month 1`,
        question: `Allie stepped into the sleek, modern office, her heart racing with anticipation. It was her first day at a competitive, fast-paced tech company, and the atmosphere buzzed with a mix of excitement and tension. She couldn’t help but notice the subtle glances from her new colleagues, sizing her up as she settled into her desk. The unfamiliar scent of fresh coffee and printer ink filled the air, and she knew the day ahead would be full of challenges.</p>Her manager, Daniel, handed her a stack of files, mentioning an important meeting happening in the conference room. As Allie quickly glanced through the files, she noted the strategic decisions and complex reports that she would have to manage. Walking toward the conference room, she mentally prepared for how she could best approach the meeting ahead.</p>The meeting room was already filled with senior executives when she arrived.</p>`,
        answers: [
    ...
    // --------------------------------Question2D--------------------------------2
    {
        ...
        question:
            `As the meeting progressed, Allie's assertiveness caught the attention of the senior leadership. Later, Daniel approached her, clearly impressed. "Allie, you showed great initiative in there," he praised. "We need someone who can step up and lead. I think you might be just the person we're looking for."</p> Back at her desk, Allie reflected on Daniel’s words, realizing the importance of this early recognition. She knew building upon this momentum would be crucial to her success at the company. With opportunities opening up, she recognized the need to make strategic decisions about her next steps.</p>Allie knew this was a pivotal moment to solidify her reputation and position herself effectively for future opportunities. She considered her next step carefully.</p>`,
        answers: [
...

    {
        ...
        question:
            `By the time the project kicked off, Allie was already familiar with the team’s strengths and weaknesses. She had quickly assembled a detailed project timeline, setting clear, attainable deadlines for each task. The team was working hard, but there were signs of friction. Some members were unsure of how to prioritize their work, and the project’s complexity was causing delays.</p>Allie’s focus was on pushing through the obstacles. Every morning, she checked in with the project leads, streamlined the communication process, and personally reviewed all progress reports.</p>One morning, her phone buzzed with a critical notification: her manager had set a meeting with her to review progress, and the deadline was fast approaching. It was clear to Allie that the project needed to be completed on time, no exceptions. There was no room for hesitation.</p>Her thoughts raced as she considered how to handle the pressure:</p>`,
        answers: [
    ...
    // --------------------------------Question4D--------------------------------7
    {
        ...
        question:
            `The deadline was fast approaching, and Allie felt the weight of the project on her shoulders. With her team stretched thin and a few of the tasks behind schedule, Allie knew she needed to make decisive moves. She spent long nights refining the project’s details, finding ways to cut down on inefficiencies. She knew her style—streamlined, direct, and results-oriented—was going to get them across the finish line.</p>Allie held a meeting to assess the situation. She asked for daily updates from each department, emphasizing that there would be no room for delays. The team responded to her assertiveness; they appreciated the clarity and direction. As the day of the final presentation drew closer, Allie ensured that every team member was aligned with the company’s goals. She pushed them to maintain focus.</p>However, there was still pressure to ensure everything was aligned perfectly. Allie’s focus shifted to handling these final stages with utmost precision:</p>`,
        answers: [
    ...
    // --------------------------------Question5--------------------------------11
    {
        ...
        question:
            `Allie’s leadership was becoming more apparent as she guided the project through its final stages. The team had been working late nights, but Allie knew the final stretch was the hardest part. She’d already established herself as someone who could command results under pressure, and now she was about to prove it again.</p>On the day of the big presentation, Allie stood confidently in front of the executive team. She presented the results of the project—successfully completed ahead of schedule, under budget, and with high-impact outcomes. Her ability to think strategically and act decisively had won her the team’s respect.</p>But Allie knew that this success was only the beginning. Her manager now trusted her to handle larger, more complex projects. There was a buzz around the office—Allie had become the go-to leader for high-stakes challenges.</p>The email notification arrived with the subject line: “Next Phase: Major Project Involving Multiple Teams and Deadlines.” Allie could feel the pressure building again, but she was more than ready for the challenge:</p>`,
        answers: [
    ...
    // --------------------------------Question6D--------------------------------12
    {
        ...
        question:
            `As the next project loomed on the horizon, Allie quickly assessed the scope and scale. The project involved multiple teams, cross-departmental collaboration, and complex deliverables. As the deadlines approached, she knew that the team’s success depended on her unwavering leadership and constant drive for results.</p>She scheduled daily meetings with the project leads, checking every detail, reviewing progress, and making swift decisions when things went off track. Allie’s reputation as someone who could maintain momentum under pressure was well-known in the office, and now, more than ever, her determination to keep pushing was evident.</p>There was no room for error, and Allie remained steadfast. As the deadline approached, she made sure each task was completed on time, even if it meant leading from the front in a more hands-on way:</p>`,
        answers: [
    ...
    // --------------------------------Question6I--------------------------------13
    {
        ...
        timeline: `Month 9 - Month 12`,
        question:
            `Allie stood at the front of the room, scanning the faces of her team. They were all working hard, but the atmosphere was growing tense with the approaching deadline. Allie knew the key to success in this final stretch wasn’t just about deadlines or results; it was about keeping the team motivated and excited about the progress they had made. She could sense that morale was starting to dip, and she knew it was time to inject some energy into the room.</p>Allie clapped her hands together, smiling brightly. She reminded everyone of how far they had come, the progress they’d made, and how close they were to reaching their goal. She urged them to keep the energy up, to stay positive, and to believe in their ability to meet the deadline. But now, as she looked around the room, Allie realized she needed to decide whether to focus on maintaining enthusiasm or make sure the tasks ahead were delegated efficiently.</p>`,
        answers: [
    ...
    // --------------------------------Question7--------------------------------16
    {
        ...
        question:
            `By the time the project was completed, Allie had not only gained the respect of her colleagues, but she had also started to make a name for herself as someone who could take charge and achieve results when others might hesitate. Her decisiveness and direct approach had earned her the admiration of her peers and senior management.</p>As the days passed, her role in the company began to evolve. She was entrusted with handling the high-level strategies, coordinating large teams, and making decisions that would directly impact the company’s growth. But her journey had only just begun. A new challenge lay ahead, and it would require more leadership than ever before.</p>Her phone buzzed with an exciting announcement: a new team member, Jake, would be joining their group to help with a project involving cross-departmental work. His reputation for driving efficiency and meeting deadlines had preceded him.</p>`,
        answers: [
    ...
    // --------------------------------Question8D--------------------------------17
    {
        ...
        question:
            `With Jake now onboard, Allie took the reins of their next project, an international product launch that was set to go live in just a few months. She quickly evaluated the scope of the project and knew it was going to be a test of both her leadership and her ability to make quick decisions.</p>Jake was quick to get to work, complementing Allie’s leadership style. Allie immediately set a course of action, defining each team’s responsibilities and implementing systems to track progress in real-time. She delegated with confidence but kept a tight hold on the major decisions. Jake’s presence brought a fresh perspective, but Allie knew it was her decisive approach that would ultimately lead the team to success.</p>As the project progressed, Allie pushed for results but also ensured Jake was empowered to take ownership of parts of the project. Her balanced leadership, clear vision, and focus on the bigger picture kept everyone aligned:</p>`,
        answers: [
    ...
    // --------------------------------Question9--------------------------------21
    {
        ...
        question:
            `The first international product launch had been a resounding success, and Allie’s leadership was recognized across the organization. With Jake’s continued involvement, the company had exceeded revenue projections, and Allie was now ready for a new challenge: expanding into multiple new regions with a flagship product.</p>Jake was integral to the strategy, but Allie knew the scale of this project required her vision to guide the team. She kept a tight rein on the overall strategy, but was keen to let Jake lead the day-to-day execution. The project involved multiple regions, new marketing strategies, and complex logistics, all of which needed to be executed flawlessly.</p>Allie’s leadership had proven itself time and time again, and she was eager to tackle this challenge head-on:</p>`,
        answers: [
    ...
    // --------------------------------Question10D--------------------------------22
    {
        ...
        question:
            `The expansion project was well underway, and Allie’s leadership had set the pace. She was handling multiple teams, coordinating efforts across departments, and ensuring the company’s expansion was smooth. The project was on track to exceed expectations, and the leadership team trusted Allie’s vision.</p>Jake continued to play a pivotal role, executing Allie’s strategy with precision. However, Allie remained at the helm, making strategic decisions that would determine the success of the expansion. As the final stages of the project approached, she began to think ahead about her next move within the company.<p/>With the successful launch of the new product line, Allie knew it was time to move into more senior leadership roles, focusing on shaping the long-term strategy for the company’s growth. Her focus on results and her ability to drive high-impact decisions had earned her the trust of the executive team:<p/>`,
        answers: [
    ...
    // --------------------------------QuestionEND--------------------------------26
    {
        ...
        dominanceConclusion:
            `Allie’s career soared over the next two decades. Her unwavering focus on results and her ability to make quick, decisive decisions set her apart. Within two years, she had become the Chief Operating Officer (COO) of the company, overseeing company-wide operations and driving efficiency across departments. Her leadership style was known for its no-nonsense approach, and she consistently delivered outstanding results under tight deadlines.</p>By her 10th year, Allie had expanded her role beyond the company, becoming a sought-after consultant for tech startups and major corporations looking to optimize their operations. Her ability to turn failing projects around, streamline processes, and create high-performing teams made her an industry leader.</p>By the 20th year of her career, Allie was named Chief Executive Officer (CEO), leading the company through global expansion, acquisitions, and new product innovations. Under her leadership, the company grew to become one of the most successful tech firms in the world, expanding into international markets and redefining industry standards.</p>Allie’s future was firmly anchored in her ability to make tough decisions, maintain relentless drive, and inspire her teams to push for excellence. Her legacy was one of fierce leadership, and her influence would continue to shape the tech industry for years to come.</p>`,
        influenceConclusion:
            `By the end of Allie’s first day, she had already established strong connections with her team, particularly with Jake. Her infectious enthusiasm and ability to motivate others helped bring the project to life, with the team feeling energized and committed under her leadership. Allie’s influence was felt not just through her ideas but through her ability to uplift the entire team’s spirit. She knew how to bring people together, keep morale high, and maintain momentum even during challenging moments. Her energy proved that collaboration and positivity were essential to her leadership style.</p>In the following months, Allie’s natural charisma and people skills opened doors to even more opportunities. As the team flourished, she found herself not only leading successful projects but also mentoring others, helping them develop their own careers. Over the next two years, Allie took on a leadership development role, where she was responsible for guiding and inspiring new leaders within the organization. Her path to becoming a Senior Leadership Coach was clear, and she began to train others in the skills that had helped her rise through the ranks.</p>Her career flourished as she combined her expertise in motivating teams with her passion for leadership development. Allie became the go-to person for advice on team dynamics and was soon recognized for her ability to turn any team into a high-performing group. Within two years, Allie found herself being considered for a global leadership role, tasked with shaping the leadership culture for the entire company.</p>Allie’s future was bright, filled with opportunities to connect with people and inspire change. As a charismatic and persuasive leader, she would continue to build teams, mentor individuals, and help organizations achieve their highest potential. In two years, Allie’s career would have taken her to the top of the leadership development field, where she would coach leaders across the world.</p>`,
        steadinessConclusion:
            `As Allie wrapped up her first day, she realized that her quiet but steady approach had worked wonders. She had created a calm, supportive atmosphere on the team, and Jake appreciated her steady hand in keeping everyone focused and balanced. She didn’t rush decisions but took the time to ensure every detail was in place. The team thrived under her leadership, with Allie offering thoughtful guidance and consistent support, especially during stressful moments. It was clear that Allie’s strength was in maintaining harmony and stability within the group.</p>In the coming months, Allie’s reputation for being a reliable and supportive leader spread across the organization. Her calm demeanor in the face of challenges allowed her to manage projects with grace. She moved into a role as a Project Manager, where her ability to keep things running smoothly and ensure that deadlines were met with a consistent pace became her trademark. Her leadership style allowed her to foster a sense of security within the team, and she was trusted to handle the most sensitive projects.</p>By the 20th year of her career, Allie was named Chief Executive Officer (CEO), leading the company through global expansion, acquisitions, and new product innovations. Under her leadership, the company grew to become one of the most successful tech firms in the world, expanding into international markets and redefining industry standards.</p>Looking ahead, Allie’s future lay in roles that valued stability, trust, and long-term relationship building. Her career trajectory would likely lead her to a position in senior management, where she would continue to create supportive environments for employees. In two years, Allie would be regarded as the glue that held the organization together, ensuring that its core values and culture remained intact despite external pressures.</p>`,
        conscientiousnessConclusion:
            `Allie’s first day concluded with her demonstrating a level of precision and careful analysis that was truly impressive. She led the project with a meticulous attention to detail, ensuring every aspect was accounted for. While Jake took on the day-to-day execution, Allie ensured the project was on track by reviewing every component and making adjustments as needed. Her logical, well-thought-out approach to problem-solving helped guide the team through complex issues and ultimately led to the successful completion of the project.</p>In the months that followed, Allie’s attention to detail and ability to analyze situations from all angles made her the go-to person for quality control and process improvement. Her ability to spot inefficiencies and improve systems quickly earned her recognition, and she was promoted to a role in process optimization. Within two years, Allie was managing a team of analysts, refining business processes, and overseeing quality assurance across multiple projects. She became known for her methodical approach and unwavering commitment to excellence.</p>Allie’s career path continued to evolve as she embraced roles that required strategic thinking and a commitment to precision. In two years, she could be found in a Senior Project Management or Quality Assurance position, where she would drive improvements in the company’s systems and processes. Her attention to detail and love for perfection made her ideal for roles that required constant review and improvement. Allie’s reputation for excellence would follow her wherever she went, and she would likely be sought after for her ability to optimize and enhance operations.</p>Looking to the future, Allie’s career would revolve around roles that required high levels of analysis, planning, and execution. She would continue to thrive in environments where structure and precision were valued, ultimately moving into leadership positions in operational strategy or process management. In two years, Allie would be leading efforts to improve the company’s overall efficiency, ensuring that every aspect of its operations met the highest standards of quality.</p>`
    }
];

// Shared DISC style titles & descriptions for this assessment -----Adults-------
// const DstyleTitle = 'The Leader';
// const IstyleTitle = 'The Motivator';
// const SstyleTitle = 'The Supporter';
// const CstyleTitle = 'The Analyzer';

// const DstyleDescription = ` - Driven and focused on results, individuals with a dominant personality are natural leaders. They thrive in high-pressure environments and excel at making decisions quickly. Motivated by challenges, they take charge and lead with confidence.`;

// const IstyleDescription = ` - Social, enthusiastic, and persuasive, Influential individuals excel in inspiring and motivating others. They are natural communicators and thrive in collaborative environments. Their positivity and energy help them connect with and engage their teams.`;

// const SstyleDescription = ` - Calm, dependable, and empathetic, Steady individuals provide stability in their teams. They are great listeners, value harmony, and excel in creating supportive environments. Their patience and consistency make them reliable team players.`;

// const CstyleDescription = ` - Methodical and precise, Conscientious individuals are detail-oriented and strive for perfection. They excel in analyzing data, ensuring accuracy, and maintaining high standards. Their focus on quality and structure makes them invaluable in tasks requiring attention to detail.`;

// Scoring config for D / I / S / C mapping

// Shared DISC style titles & descriptions for kids (seed-ready)
const DstyleTitle = 'The Explorer';
const IstyleTitle = 'The Encourager';
const SstyleTitle = 'The Helper';
const CstyleTitle = 'The Thinker';

const DstyleDescription = ` - Bold and ready for action, Explorer kids like taking charge, solving challenges, and leading the group when things get exciting.`;

const IstyleDescription = ` - Friendly, cheerful, and full of ideas, Encourager kids enjoy helping friends, making others smile, and bringing positive energy to every activity.`;

const SstyleDescription = ` - Calm, patient, and caring, Helper kids make others feel safe, work well with teammates, and bring steady support to every situation.`;

const CstyleDescription = ` - Careful and curious, Thinker kids like understanding how things work, paying attention to details, and completing tasks with focus and care.`;
...
const category = {
    shelf: 'Kids',
    subcategories: ['Relationships', 'Playground', 'School']
};
...
(async () => {
    try {
        ...
        await Assessment.updateOne(
            { slug: 'shanes-day-at-the-park' },
            {
                $set: {
                    ...
                    description: "Kids DISC scenario at the playground with Shane.",
                    creditsCost: 1,
                    isActive: true,
                    category,
                    DstyleTitle,
                    ...
                    // Scenario questions (currently empty placeholder)
                    questions
                }
            },
            { upsert: true }
        ...
        console.log("Updated Shane's Day at the Park! assessment metadata and questions.");
    } catch (err) {
        console.error(err);
    } finally {
